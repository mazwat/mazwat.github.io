...
In this case  we have the current, .24 amps (<span class="katex"></span>) and the resistance, 150 ohms even though we don’t know the voltage.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzODAzOTg0NSw2NjE1OTg1NTgsLTIyMz
