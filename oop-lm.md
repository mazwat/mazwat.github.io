...
In the TinkerCAD version presented in the link above we have created a rought apporaximation of OOP in a C++ you can see that class Traffic_Light has been defined and 3 instances of Traffic_Lights have been in
**Code in TinkerCAD**
```c++
class Traffic_Light
{
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODU4ODExODQsLTE0MzU2OTE3ODgsMT
